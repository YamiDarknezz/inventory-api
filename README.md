...
- 16 automated tests covering auth, CRUD and RBAC
...
Coverage: auth (register, duplicate, validation, login, wrong password), products (CRUD, RBAC, 400/401/403/404), users (RBAC).
